...
public class Generadorelemental : MonoBehaviour {
    ...
    IEnumerator crear()
    {
        ...
        Elementalai ai1 = newminion1.GetComponent<Elementalai>();
        Elementalai ai2 = newminion2.GetComponent<Elementalai>();
        Elementalai ai3 = newminion3.GetComponent<Elementalai>();
        Elementalai ai4 = newminion4.GetComponent<Elementalai>();
        Elementalai ai5 = newminion5.GetComponent<Elementalai>();
        ai1.player = player1;
        ai2.player = player1;
        ai3.player = player1;
        ai4.player = player1;
