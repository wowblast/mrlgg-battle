...
public class murloc4ai : MonoBehaviour {
    ...
    void Start()
    {
        ...
        player = GameObject.Find("nerubian1(Clone)");
    ...
    void Update()
    {
        try
        {
            ...
            {
                enemyspeed = 0.15f;
                minion.GetComponent<Animator>().Play("Run [19]");
            ...
            if (heading.sqrMagnitude < 105.9702 && isatttacking == false)
            {
                ...
                minion.GetComponent<Animator>().Play("SpecialUnarmed [0]");
